...
class HomeTilesClass extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", null, 
            React.createElement(Card_1.Card, {style: { backgroundImage: "url(./public/icons/budgetpedia-pale.jpg",
                backgroundSize: "cover" }}, 
                React.createElement("div", {style: { float: "left", margin: "9px 3px 3px 3px" }}, 
                    React.createElement("img", {style: { width: "100px" }, src: "./public/icons/budgetpedia-logo.png"})
                ), 
                React.createElement(Card_1.CardTitle, null, "Welcome to Budgetpedia. We're all about government budgets."), 
                React.createElement(Card_1.CardText, null, 
                    React.createElement("p", {style: { margin: 0, padding: 0 }}, 
                        ...
                        "." + ' ' + "See a sample of Toronto's annual budget decision process at our Budget Roadmap ", 
                        React.createElement("em", null, "[link pending]"), 
                        "."), 
                    React.createElement("p", null, "We welcome you to join us (and contribute!) on any of our digital platforms:"), 
                    React.createElement("ul", null, 
                        React.createElement("li", null, 
                            ...
                            " For" + ' ' + "discussions: our Facebook group (", 
                            React.createElement("a", {href: "http://facebook.com/groups/budgetpedia", target: "_blank"}, "facebook.com/groups/budgetpedia"), 
                            ")"), 
                        React.createElement("li", null, 
                            React.createElement("a", {href: "http://facebook.com/budgetpedia", target: "_blank"}, 
                                React.createElement("img", {style: { height: "16px", verticalAlign: "middle" }, src: "./public/icons/facebook.png"})
                            ), 
                            " For" + ' ' + "lists of resources: our Facebook page (", 
                            React.createElement("a", {href: "http://facebook.com/budgetpedia", target: "_blank"}, "facebook.com/budgetpedia"), 
                            ")"), 
                        React.createElement("li", null, 
                            ...
                            " For" + ' ' + "notifications: Twitter (", 
                            React.createElement("a", {href: "http://twitter.com/budgetpedia", target: "_blank"}, "twitter.com/budgetpedia"), 
                            ")"), 
                        React.createElement("li", null, 
                            ...
                            " For" + ' ' + "in-depth articles: Medium (", 
                            React.createElement("a", {href: "http://medium.com/budgetpedia", target: "_blank"}, "medium.com/budgetpedia"), 
                            ")"), 
                        React.createElement("li", null, 
                            ...
                            " For" + ' ' + "technical discussions: our Google forum (", 
                            React.createElement("a", {href: "http://groups.google.com/d/forum/budgetpedia", target: "_blank"}, "groups.google.com/d/forum/budgetpedia"), 
                            ")")), 
