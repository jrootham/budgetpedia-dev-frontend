...
let Explorer = class extends Component {
    constructor(props) {
        ...
        this.state = {
            budgetBranches: [
                new budgetbranch_1.default({ data: {}, nodes: [], settings: this.props.settings.defaults.branch })
            ],
            dialogopen: false,
        };
