...
class ExplorerBranch extends Component {
    ...
    render() {
        ...
        let inflationadjustment = React.createElement("div", {style: { display: 'inline-block', whiteSpace: "nowrap", verticalAlign: "bottom" }}, React.createElement(Toggle_1.default, {label: 'Inflation adjusted:', style: { height: '32px' }, labelStyle: { fontStyle: 'italic' }, defaultToggled: true}));
