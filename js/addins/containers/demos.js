    ...
    render() {
        return React.createElement("div", null, 
            React.createElement(Card_1.Card, null, 
                React.createElement(Card_1.CardTitle, null, "Get a Demo"), 
                ...
                React.createElement(Card_1.CardText, null, "Get Henrik (the project lead) to demo the site for you."), 
                ...
                React.createElement(Card_1.CardText, null, "In addition to gaining a better understanding of the city budget, you'll" + ' ' + "also learn how you can get involved in making a difference in the" + ' ' + "development of the newest city budget."), 
                React.createElement(Card_1.CardText, null, 
