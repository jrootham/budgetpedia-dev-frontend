                ...
                React.createElement(Card_1.CardText, null, 
                    ...
                    React.createElement("ul", {style: { marginBottom: "16px" }}, 
                        React.createElement("li", null, 
                            ...
                            React.createElement("p", null, "Join us for the official launch of Budgetpedia version 0.1 at" + ' ' + "Civic Tech's weekly meetup. See Budgetpedia in action, gain insights" + ' ' + "into the city budget and generally celebrate our going live.")), 
                        React.createElement("li", null, 
                            React.createElement("p", null, 
                                React.createElement("strong", null, "Regular Meetups: First and Third Tuesday of each month 6:30-9:00 pm "), 
                                React.createElement("br", null), 
                                React.createElement("em", null, " Location:"), 
                                " ", 
                            ...
                            React.createElement("p", null, "This is where Budgetpedia was born and raised to its current early state." + ' ' + "It's also where a lot of the brainstorming, development and creative" + ' ' + "processes happen." + ' ' + "Anyone with an interest in this project is welcome.  No coding or" + ' ' + "technical skills required!"), 
                            React.createElement("p", null, 
