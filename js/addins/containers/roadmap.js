...
class Roadmap extends Component {
    constructor() {
        ...
        this.openTMMISWindow = (url) => {
            let handle = open(url, "_blank");
            setTimeout(() => {
                handle.open(url);
            }, 1000);
        };
                ...
                React.createElement(Card_1.CardText, {expandable: true, style: {
                    ...
                    React.createElement("ul", null, 
                        React.createElement("li", null, 
                            "Budget Committee: ", 
                            React.createElement("a", {onTouchTap: () => { this.openTMMISWindow("http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=1022#Meeting-2016.BU25"); }}, "November 4"), 
                            " ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=1022#Meeting-2016.BU26"}, "November 18"), 
                            " [wrapup TBD] ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=1022#Meeting-2016.BU27"}, "November 28"), 
                            " "), 
                        React.createElement("li", null, 
                            "Executive Committee: ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=966#Meeting-2016.EX20"}, "December 1")), 
                        React.createElement("li", null, 
                            "City Council: ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=961#Meeting-2016.CC23"}, "December 13 & 14"))), 
                    React.createElement("h3", null, "Tax supported budgets (eveything else)"), 
                    React.createElement("ul", null, 
                        React.createElement("li", null, 
                            "Budget Committee: ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=1022#Meeting-2016.BU28"}, "December 2"), 
                            " ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=1022#Meeting-2016.BU29"}, "December 16, 19 & 20, possibly 21"), 
                            " [wrapup TBD] ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=1022#Meeting-2017.BU30"}, "January 5, 9 & 10"), 
                            " ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=1022#Meeting-2017.BU31"}, "January 12"), 
                            " ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=1022#Meeting-2017.BU32"}, "January 24"), 
                            " "), 
                        React.createElement("li", null, 
                            "Executive Committee: ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=966#Meeting-2017.EX22"}, "February 7")), 
                        React.createElement("li", null, 
                            "City Council: ", 
                            React.createElement("a", {target: "_blank", href: "http://app.toronto.ca/tmmis/decisionBodyProfile.do?function=doPrepare&decisionBodyId=961#Meeting-2017.CC25"}, "February 15, 16, possibly 17"))))), 
            React.createElement(Card_1.Card, null, 
