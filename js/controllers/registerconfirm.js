...
class RegisterConfirmClass extends Component {
    ...
    render() {
        ...
        let registerconfirmview = auth.isAuthenticated
            ?
                React.createElement("div", null, React.createElement("p", null, auth.user.username, ", your registation has been confirmed, and you are logged in."))
            : registerconfirm.isConfirmed
                ?
                    React.createElement("div", null, React.createElement("p", null, "Thanks for confirming your registration, ", registerconfirm.user.username, "!"), React.createElement("p", null, "Automatic login did not occur, however. Please try logging in again."))
                :
